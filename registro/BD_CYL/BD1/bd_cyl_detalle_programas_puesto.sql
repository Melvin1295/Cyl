...
--
-- Table structure for table `detalle_programas_puesto`
--

DROP TABLE IF EXISTS `detalle_programas_puesto`;
...
CREATE TABLE `detalle_programas_puesto` (
  ...
  KEY `fk_detalleProgramas_puestos` (`codigo_puestos`),
  KEY `fk_detalleProgramas_programas` (`codigo_programas`),
...
--
-- Dumping data for table `detalle_programas_puesto`
--

LOCK TABLES `detalle_programas_puesto` WRITE;
/*!40000 ALTER TABLE `detalle_programas_puesto` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_programas_puesto` ENABLE KEYS */;
UNLOCK TABLES;
