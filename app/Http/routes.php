...
Route::get('api/allDepartamento/registro','PageController@allDepartamento');
Route::get('api/allDistrito/registro','PageController@allDistrito');
Route::get('api/allProvince/registro','PageController@allProvince');
...
Route::get('api/all3/registro','PostulanteController@all3');
Route::get('api/all4/registro','PostulanteController@all4');
Route::get('api/all5/registro','PostulanteController@all5');
Route::get('api/all6/registro','PostulanteController@all6');
